...
// import * as formResponseTracker from "./formResponseTracker";
// import { FormEventInterface } from "../../utils/formTrackerUtils/formTracker.interface";
...
//     const isDataSensitive = false;
//     const enableFormResponseTracking = true;
//     FormResponseTracker(isDataSensitive, enableFormResponseTracking);
//     document.body.innerHTML =
//       '<div id="main-content">' +
//       '<form action="/test-url" method="post">' +
//       "<fieldset>" +
