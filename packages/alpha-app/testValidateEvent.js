...
export default function () {
  group('Event Catalogue Validation Tests', () => {
    console.log('Testing validateEvent function from @govuk-one-login/event-catalogue-utils');
    ...
    group('Invalid Event Tests', () => {
      ...
      const invalidResult = testEventValidation('INVALID_INCOMPLETE_EVENT', invalidEvent);
    ...
    group('Unknown Event Tests', () => {
      ...
      const unknownResult = testEventValidation('UNKNOWN_EVENT_TYPE', unknownEvent);
