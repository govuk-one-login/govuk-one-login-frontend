...
- **885:** updated tests to remove code smell error ([af724ec](https://github.com/govuk-one-login/govuk-one-login-frontend/commit/af724ec))
...
- **885:** updated tests to remove code smell error ([0bc8462](https://github.com/govuk-one-login/govuk-one-login-frontend/commit/0bc8462))
...
- **headers:** Updating package.json main, module and export paths plus minor config ([dba7ccb](https://github.com/govuk-one-login/govuk-one-login-frontend/commit/dba7ccb))
