...
describe("getFormFields", () => {
  ...
  afterEach(() => {
    // Correctly remove the form element from the DOM
...
describe("isExcludedType", () => {
  ...
  test("isExcludedType should return true for hidden input type", () => {
    ...
    const result = FormTracker.isExcludedType(htmlInputElement);
...
//     const result = FormTracker.getElementValue(htmlInputElement);
...
//   let htmlCheckboxElement: HTMLInputElement;
//   let htmlCheckboxElement2: HTMLInputElement;
//   let htmlLabelElement: HTMLLabelElement;
//   let htmlLabelElement2: HTMLLabelElement;

//   beforeEach(() => {
//     htmlCheckboxElement?.remove();
//     htmlCheckboxElement2?.remove();
//     htmlLabelElement?.remove();
//     htmlLabelElement2?.remove();
//   });
...
//     FormTracker.processCheckbox(htmlCheckboxElement);
...
//     FormTracker.processCheckbox(htmlCheckboxElement);
//     FormTracker.processCheckbox(htmlCheckboxElement2);
//     expect(FormTracker.selectedFields).toEqual([
//       {
//         id: "checkboxId",
//         name: "checkboxName",
